...
class HalfCheetahEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release.
    ...
    def step(self, action):
        ...
        # ===== safety: body height =====
        z_height = self.data.qpos[1]          # torso height
        ...
        marker_pos = torso_pos + np.array([0.0, 0.0, 1.0])
    ...
    def reset_model(self):
        ...
        self.init_qpos[1], self.init_qpos[3], self.init_qpos[6] = -0.3, 0.5, -0.75 # initialize joints to start in a safe set.
